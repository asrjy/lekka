...
bot = Bot(token='6050710246:AAFTgW0HaocZbETvuRbxiLIuTrbXzxh0_6Q')
dp = Dispatcher(bot)
...
button3 = InlineKeyboardButton(text="👋 button3", callback_data="randomvalue_of10")
...
async def random_value(call: types.CallbackQuery):
    if call.data == "randomvalue_of10":
        # keyboard_inline = InlineKeyboardMarkup().add(button3, button4)
        InlineKeyboardMarkup().add(button1, button2)
